...
| フォルダ一覧 | サムネイルグリッド | フルスクリーン表示 | 設定・鍵のバックアップ |
|:---:|:---:|:---:|:---:|
| ![フォルダ一覧](screenshots/ios_01_folders.png) | ![サムネイルグリッド](screenshots/ios_02_grid.png) | ![フルスクリーン表示](screenshots/ios_03_viewer.png) | ![設定](screenshots/ios_04_settings.png) |
